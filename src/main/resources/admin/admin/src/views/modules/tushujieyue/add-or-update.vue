<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="借阅说明" prop="jieyueshuoming">
          <el-input v-model="ruleForm.jieyueshuoming" 
              placeholder="借阅说明" clearable  :readonly="ro.jieyueshuoming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="借阅说明" prop="jieyueshuoming">
              <el-input v-model="ruleForm.jieyueshuoming" 
                placeholder="借阅说明" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
