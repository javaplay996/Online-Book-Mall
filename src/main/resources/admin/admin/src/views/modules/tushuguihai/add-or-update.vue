    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="归还说明" prop="guihaishuoming">
                <el-input
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.guihaishuoming" label="归还说明" prop="guihaishuoming">
                    <span>{{ruleForm.guihaishuoming}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
